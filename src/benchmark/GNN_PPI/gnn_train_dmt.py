...
parser.add_argument('--description', default='KeAP20_27k', type=str,
...
parser.add_argument('--use_dmt', default="False", type=boolean_string)
...
parser.add_argument('--balance', default=1e-5, type=float)
