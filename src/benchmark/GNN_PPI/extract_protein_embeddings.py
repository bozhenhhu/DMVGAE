...
if __name__ == '__main__':
    ...
    model = BertModel.from_pretrained("weights/prot-bert")
    model.to('cuda:0')
    ...
    #     './pretrained',
    #     './data/PPI_embeddings/protein_embedding_KeAP20_shs27k.npy'
    # )
    ...
    #     './pretrained',
    #     './data/PPI_embeddings/protein_embedding_KeAP20_shs148k.npy'
    # )
    ...
    #     './pretrained',
    #     './data/PPI_embeddings/protein_embedding_KeAP20_STRING.npy'
    # )
